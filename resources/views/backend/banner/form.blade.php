...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-xl-3 col-md-12 col-sm-12">
            ...
            <select name="type" id="type" class='form-control' required='' {{ !empty($banner->id) ? 'disabled' : ""}}>
              @foreach($types as $type)
              <option value="{{ $type }}" {{ !empty($banner->type) && $banner->type == $type ? 'selected' : '' }}>
                {{ $type }}
              </option>
              @endforeach
            </select>
              ...
              <div class="card-body">
                <div class="row form-silde">
                  <div class="col-xl-3 col-md-12 col-sm-12">
                    ...
                    <select name="static_type" id="static_type" class='form-control slide_type' required>
                  ...
                  <div class="col-xl-3 col-md-12 col-sm-12 slide-pic">
                    ...
                    <label class="text-pic">ขนาดภาพที่แนะนำ 1920x768 (ขนาดไม่เกิน 5 MB)</label>d
                  </div>
    ...
    <div class="row mt-3 mr-1 dynamic" style='display: none;'>
      <div class="col-md-12">
        <div class="row">
          <div class="col-xl-12 col-md-12 col-sm-12" id="slide-box">
            <div class="card border" id="slide-content-1">
              <div class="card-body">
                <div class="row mb-3">
                  <label class='control-label-title mr-3' id="slide-count">Slide 1</label>
                  <i class="fas fa-2x fa-times-circle text-danger d-none decrease-slide" title="ลบสไลด์นี้"
                    onclick="decreaseSlide(this)"></i>
                </div>

                <div class="row form-silde mb-3">
                  <div class="col-md-4">
                    <label class='col-form-label'>ตำแหน่งของสไลด์</label>
                    <select name="slide_position[]" class='form-control slide_position' required>
                      @for ($pos = 1; $pos <= 10; $pos++) <option value="{{ $pos }}">{{ $pos }}
                        </option>
                        @endfor
                    </select>
                  </div>
                ...
                <div class="row form-slide">
                  <div class="col-md-6 slide-pic">
                    <label class="col-form-label " for="slide_upload_pc">
                      รูป PC <span class="text-danger">*</span> :
                    </label>
                  ...
                  <div class="col-md-6 slide-pic">
                    <label class="col-form-label " for="slide_upload_mobile">
                      รูป Mobile <span class="text-danger">*</span> :
                    </label>
    ...
    {{-- Increase Banner Slide --}}
    <div class="row mt-2 dynamic" style='display: none;'>
      <div class="col-md-4">
        <button type="button" class='btn btn-block btn-success' onclick="increaseSlide()">
          <i class='fas fa-plus'></i> เพิ่มสไลด์แบนเนอร์
        </button>
      </div>
    </div>
    {{-- End : New Slide --}}
              ...
              <div class="card-body">
                <div class="row form-silde">
                  <div class="col-xl-2 col-md-12 col-sm-12">
                    ...
                    <label class='col-form-label' for="static_type">ประเภท <span class='text-danger'> * </span> :
                    </label>
                    <select name="edit_type" id="static_type" class='form-control slide_type' required>
                      <option value="image" {{$banner_detail->type == 'image' ? 'selected' : ''}}>
                        image</option>
                      {{-- <option value="video" {{$banner_detail->type == 'video' ? 'selected' : ''}}>video
                      </option> --}}
                      <option value="youtube" {{$banner_detail->type == 'youtube' ? 'selected' : ''}}>youtube</option>
                    </select>
                  </div>
                  ...
                  <div class="col-xl-3 col-md-12 col-sm-12">
                    <label class='col-form-label' for="static_type">Link <span class='text-danger'>
                        * </span> : </label>
                    <input type="text" name='edit_url' class=' form-control mt-2' value="{{$banner_detail->url}}">
                  </div>
                  ...
                  <div class="col-xl-3 col-md-12 col-sm-12 slide-pic">
                    ...
                    <div class="d-flex justify-content-center">
                      <img src="{{$banner_detail->slide_banner_pc}}" class="img-thumbnail m-4 img-preview"
                  ...
                  <div class="col-xl-3 col-md-12 col-sm-12 slide-pic">
                    ...
                    <label class="text-pic">ขนาดภาพที่แนะนำ 1920x768 (ขนาดไม่เกิน 5 MB)</label>
                    <div class="d-flex justify-content-center">
                      <img src="{{$banner_detail->slide_banner_mobile}}" class="img-thumbnail m-4 img-preview"
      ...
      <div class="col-md-12">
        <div class="row">
          <div class="col-xl-12 col-md-12 col-sm-12" id="slide-box">
            ...
            @foreach($banner->banners_detail as $key => $banner_detail)
            <div class="card border" id="slide-content-{{ $key + 1 }}">
              <div class="card-body">
                <div class="row mb-3">
                  <label class="control-label-title mr-3 slide-count" id="slide-count">Slide {{ $key + 1 }}</label>
                ...
                <div class="row form-silde">
                  <div class="col-md-4">
                    <label class="col-form-label">ตำแหน่งของสไลด์</label>
                    <select name="edit_slide_position[]" class="form-control slide-position" required>
                      @for ($pos = 1; $pos <= 10; $pos++) <option value="{{ $pos }}"
                        {{ $banner_detail->slide_position == $pos ? 'selected' : ''}}>
                        {{ $pos }}
                        </option>
                        @endfor
                    </select>
                  ...
                  <div class="col-md-4">
                    ...
                    <select name="edit_type[]" class='form-control slide_type edit' id="{{ $key }}" required>
                      <option value="image" {{ $banner_detail->type == 'image' ? 'selected' : '' }}>Image</option>
                      <option value="youtube" {{ $banner_detail->type == 'youtube' ? 'selected' : '' }}>Youtube
                      </option>
                    </select>
                  </div>

                  <div class="col-md-4 side-url">
                    <label class='col-form-label ' for="edit_url">
                      Link <span class='text-danger'>*</span> :
                    </label>
                ...
                <div class="row form-silde">
                  ...
                  <div class="col-md-6 slide-pic">
                    ...
                    <input type="file" id='{{ $banner_detail->id }}' name="edit_upload_mobile[{{ $key }}]"
    ...
    <div class="row mt-2 mr-1 edit-dynamic {{ $slide }}">
      <div class="col-md-4">
        <button type="button" class='btn btn-block btn-success' onclick="increaseSlideEdit()">
          <i class='fas fa-plus'></i> เพิ่มสไลด์แบนเนอร์
        </button>
      </div>
    </div>
...
<script>
    // For Edit Banner
  function increaseSlideEdit() {
		let content = $('#slide-content-mockup');
		// let count = parseInt(content.prop('id').match(/\d+/g), 10) + 1;
		let count = $('.slide-count').length;
		let clone = content.clone(true).attr('id', 'slide-content-' + count);

		clone.find('#slide-count').text('Slide ' + count);
		clone.find('.decrease-slide').removeClass('d-none');
        clone.find('.img-preview').remove();
        clone.find('.slide-position').val(count);
		$('#slide-box').append(clone);
	}

    // For Create Banner
    function increaseSlide() {
        let content = $('div[id^="slide-content-"]:last');
            let count = parseInt(content.prop('id').match(/\d+/g), 10) + 1;
            let clone = content.clone(true).attr('id', 'slide-content-' + count);
  ...
  $(function(){
      ...
      $('.add-slide').on('click', function(e){
            ...
            '<div class="card border">'+
               '<div class="card-body">'+
                 '<div class="row form-silde">'+
                    ...
                    '</div>'+
                    '<div class="col-md-4">'+
                    '<label class="col-form-label" for="slide_type">ตำแหน่งของสไลด์ <span class="text-danger">*</span> :</label>'+
                    '<select name="slide_type[]"  class="form-control slide_type"  required>'+
                        '<option value="image">Image</option>'+
                        '<option value="youtube">Youtube</option>'+
                    '</select>'+
                  ...
                  '<div class="col-md-6 slide-pic">'+
                      ...
                      '<input type="file" name="slide_upload_pc[]" class="slide_upload_pc form-control mt-2" >'+
                      '<label class="text-pic">ขนาดภาพที่แนะนำ 1920 x 768 (ขนาดไม่เกิน 5 MB)</label>'+
                    '</div>'+
                   '<div class="col-md-6 slide-pic">'+
        ...
        $('#slide-content').clone().prependTo('#slide-box');
