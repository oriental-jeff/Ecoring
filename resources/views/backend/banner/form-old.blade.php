...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="row mt-3 mr-1 dynamic" style='display: none;'>
      <div class="col-md-12">
        <div class="row">
          <button class='btn btn-success add-slide ml-2'>
              ...
              <div class="card-body">
                ...
                <div class="row form-silde mb-3">
                  <div class="col-md-4">
                    ...
                    <select name="slide_position" class='form-control slide_type' required>
                      @for ($i = 1; $i <= 10; $i++)
                  ...
                  <div class="col-md-4">
                    <label class='col-form-label' for="slide_type">
                      รูปแบบแบนเนอร์2 <span class='text-danger'>*</span> :
                    </label>
                ...
                <div class="row mt-3 form-slide">
                    <div class="col-md-4 offset-md-4">
                        <button class="btn btn-block btn-white" onclick="removeSlide(this)">
            ...
            <div class="card border">
              <div class="card-body">
                <div class="row form-silde">
                  ...
                  <div class="col-xl-2 col-md-12 col-sm-12">
                    <label class='col-form-label' for="slide_type">รูปแบบแบนเนอร์ <span class='text-danger'> * </span> :
                    </label>
                  ...
                  <div class="col-xl-3 col-md-12 col-sm-12 slide-pic">
                    <label class="col-form-label " for="edit_slide_upload">รูป PC <span class="text-danger"> * </span> :
                    </label>
                  ...
                  <div class="col-xl-3 col-md-12 col-sm-12 slide-pic">
                    <label class="col-form-label " for="edit_slide_upload">รูป Mobile <span class="text-danger"> *
                      </span> : </label>
