	...
	<div class="row">
      ...
      <div class="panel panel-inverse gray">
        <div class="panel-body mgbt">
          <form id="form_search" action="{{ route('backend.banner.index') }}" method='post' data-parsley-validate="true">
            <div class="form-row">    
              ...
              <div class="form-group col-lg-6 col-md-12 col-sm-12 ">
                <div class='mt-4 '>
                  ...
                  @can('add banner')
                    <a href="{{ route('backend.banner.create') }}" class="btn btn-white btn-search"><i class="fa fa-plus-square fa-lg text-success"></i> เพิ่มข้อมูล</a>
                  @endcan 
                </div>
              </div>
           	</div>              
