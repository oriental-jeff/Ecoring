  ...
  <div data-scrollbar="true" data-height="100%">
    ...
    <ul class="nav">
      ...
      @canany (['access websoical', 'access webinfo', 'menu_front', 'access page'])
        <li class="has-sub {{ request()->routeIs('backend.websocial*', 'backend.webinfo*', 'backend.menu*', 'backend.page*', 'backend.bankaccounts*', 'backend.page*')  ? 'active' : '' }}">
          <a href="javascript:;">
            <b class="caret"></b>
      ...
      <li class="has-sub {{ request()->routeIs('backend.categories*', 'backend.grades*', 'backend.tags*', 'backend.products*', 'backend.product_prices*', 'backend.stocks*')  ? 'active' : '' }}">
        <a href="javascript:;">
          <b class="caret"></b>
        ...
        <ul class="sub-menu">
          ...
          @can('access product_prices')
            <li class="{{ request()->routeIs('backend.product_prices*') ? 'active' : '' }}">
              <a href="{{ route('backend.product_prices.index') }}" class="menu-link">ราคาสินค้า (ตามช่วงเวลา)</a>
            </li>
          @endcan
      ...
      <li class="has-sub {{ request()->routeIs('backend.promotions*', 'backend.promotion_details*')  ? 'active' : '' }}">
        <a href="javascript:;">
          <b class="caret"></b>
        ...
        <ul class="sub-menu">
          ...
          @can('access promotion_details')
            <li class="{{ request()->routeIs('backend.promotion_details*') ? 'active' : '' }}">
              <a href="{{ route('backend.promotion_details.index') }}" class="menu-link">รายละเอียดโปรโมชั่น</a>
            </li>
          @endcan
        </ul>
      </li>
