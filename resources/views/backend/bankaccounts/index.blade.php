    ...
    <div class="col-12 col-xl-12">
        <div class="panel panel-inverse gray">
            <div class="panel-body mgbt">
                <form id="" action="{{ route('backend.bankaccounts.index') }}" method='post'
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                            <div class='mt-4 '>
                                ...
                                @can('add bankaccounts')
                                <a href="{{ route('backend.bankaccounts.create') }}" class="btn btn-white btn-search"><i
                    ...
                    <table id="data-table-list" class="table table-striped table-bordered w-100 nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">ชื่อเรียกบัญชี</th>
                                <th class="text-center">โลโก้ธนาคาร</th>
                        ...
                        <tbody>
                            ...
                            <tr class="del">
                                <td class="text-center">
                                    <div class=" dropright">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @can('delete bankaccounts')
                                            <form
                                                action="{{ route('backend.bankaccounts.destroy', ['bankaccount' => $bankaccount->id]) }}"
                                                method="post">
                                                {{ method_field('DELETE') }}
                                            ...
                                            @endcan
                                            @can('edit bankaccounts')
                                            <div class="dropdown-divider"></div>
                                            <a href="{{ route('backend.bankaccounts.edit', ['bankaccount' => $bankaccount->id]) }}"
                                ...
                                <td class="text-center">{{ date('d/m/Y H:i:s', strtotime($bankaccount->updated_at)) }}
                                </td>
                                </td>
