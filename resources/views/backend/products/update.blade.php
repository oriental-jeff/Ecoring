  ...
  <div class="col-lg-12">
    ...
    <div class="panel " data-sortable-id="form-validation-1">
      ...
      <div class="panel-body">
        <form class="form-horizontal"  id="form-validate" name="demo-form" enctype="multipart/form-data" action="{{ route('backend.products.update', ['product' => $product->id] ) }}"  method='post'>
            @method('PATCH')
