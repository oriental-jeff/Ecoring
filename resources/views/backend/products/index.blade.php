             ...
             <div class="form-row">
                ...
                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                  <div class='mt-4 '>
                    ...
                    @can('add products')
                      <a href="{{ route('backend.products.create') }}" class="btn btn-white btn-search"><i class="fa fa-plus-square fa-lg text-success"></i> เพิ่มข้อมูล</a>
                    @endcan
                  </div>
                </div>
             	</div>
                        ...
                        <td class="text-center">
                          <div class=" dropright">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              @can('delete products')
                                <form action="{{ route('backend.products.destroy', ['product' => $product->id]) }}" method="post">
                                 {{ method_field('DELETE') }}
                              ...
                              @can('edit products')
                                ...
                                <a href="{{ route('backend.products.edit', ['product' => $product->id]) }}" class=" edit  dropdown-item" data-id="" ><i class="fa fa-pencil-alt text-warning"></i>&nbsp;&nbsp;แก้ไข</a>
                              @endcan
                            </div>
                          </div>
                        </td>
