					...
					<form action="success.php" method="post" accept-charset="utf-8">
						<div class="form-row">
							<div class="col-lg-4 col-md-6 mb-3">
								...
								<input type="text" class="form-control" id="validationDefault01" placeholder="First name" value="UCM789456123" readonly>
							</div>
						</div>
						<div class="form-row">
							<div class="col-lg-4 col-md-6 mb-3">
								...
								<div class="col-xl-4 col-lg-6 col-md-6 mb-3 align-self-end">
								    <div class="input-group">
										...
										<div class="custom-file">
										    ...
										    <label class="btn border-0 w-100 btn-FormControlFile" for="exampleFormControlFile1">อัพโหลดสลิป <i class="ml-2 fa fa-upload"></i></label>
										</div>
									</div>
								</div>
							</div>
