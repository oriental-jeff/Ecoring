    ...
    <section class="box-history">
        <div class="container">
            ...
            <div class="box-Payment font-weight-normal">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <input class="box-check" type="radio" name="exampleRadios" id="exampleRadios1" value="option1"
                            checked>
                    ...
                    <div class="col-sm-6">
                        <input class="box-check" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
...
<script>
    $(function() {
        ...
        // var checkMatch = JSON.parse(localStorage.getItem('orderList')).filter(x => {
        //     if (x.amount == 0) $('#cartID' + x.id).hide();
        // });
        // console.log(checkMatch, ':checkMatch');

    });
    function chkMatchedCart() {
