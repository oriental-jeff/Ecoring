...
<div id="content" class="content">
    ...
    <section class="box-history">
        <form class="form-horizontal" method="post" id="pay-form-validate" name="demo-form" enctype="multipart/form-data"
            action="{{ route('frontend.pay', ['locale' => get_lang()]) }}">
            @method('post')
        <div class="container">
            <h4>คำสั่งซื้อ</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 logisticScope">
                        ...
                        <label class="box-check-label" for="logistic_id{{ $k }}">
                            ...
                            อัตราค่าบริการ : <span class="base_price">{{ number_format($logistic->base_price) }} บาท<br>
                        </label>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="box-Shipment font-weight-normal">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        ...
                        <button id="customeAddr" disabled type="button" class="btn btn-secondary" data-toggle="modal"
                            data-target="#customeAddrModalCenter">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">เลือกที่อยู่ในการจัดส่ง</h5>
                        ...
                        <label class="box-check-label" for="delivery_addr_profile">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="profile_id" name="profile_id" value="{{ Auth::id() }}">
                                        <input type="text" id="profile_fullname" name="profile_fullname"
                                            value="สมหมาย คอมเมิส" readonly></td>
                                </tr>
                                <tr>
                                    <td>เบอร์โทร :</td>
                                    <td><input type="text" id="profile_mobile" name="profile_mobile" value="0567894567"
                                            readonly>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>แขวง/ตำบล :</td>
                                    <td><input type="text" id="profile_sub_district_id" name="profile_sub_district_id"
                                            value="แขวงอนุสาวรีย์" readonly></td>
                                </tr>
                                <tr>
                                    <td>เขต/อำเภอ :</td>
                                ...
                                <tr>
                                    <td>รหัสไปรษณีย์ :</td>
                                    <td><input type="text" id="profile_postcode" name="profile_postcode" value="10220"
                                            readonly></td>
                                </tr>
                            </table>
                        ...
                        <label class="box-check-label" for="delivery_addr_custom">
                            ...
                            <table>
                                <tr>
                                    <td style="min-width: 100px;">ชื่อ :</td>
                                    <td>
                                        <input type="text" id="custom_id" name="custom_id" value="{{ $logistics[0]->id }}">
                                        <input type="text" id="custom_fullname" name="custom_fullname"
                                            value="สมหมาย คอมเมิส" readonly></td>
                                </tr>
                                <tr>
                                    <td>เบอร์โทร :</td>
                                    <td><input type="text" id="custom_mobile" name="custom_mobile" value="0567894567"
                                            readonly></td>
                                </tr>
                                <tr>
                                    <td>ที่อยู่ :</td>
                                ...
                                <tr>
                                    <td>เขต/อำเภอ :</td>
                                    <td>
                                        <select class="form-control" id="custom_district_id" name="custom_district_id"
                                            readonly>
                                ...
                                <tr>
                                    <td>จังหวัด :</td>
                                    <td>
                                        <select class="form-control" id="custom_province_id" name="custom_province_id"
                                            readonly>
            ...
            <div class="row px-2">
                ...
                <div class="col-lg-2 col-md-3 col-6 px-1">
                    ...
                    onclick="$('#pay-form-validate').submit();"
