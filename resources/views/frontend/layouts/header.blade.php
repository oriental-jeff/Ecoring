        ...
        <div class="row box-menu align-items-center m-0">
            <div class="col-xl-2 col-lg-12 d-flex pl-0">
                ...
                <button class="navbar-toggler" type="button">
                    <a href="../cart" class="position-relative" id="boxOfProductmobile">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 border-left">
                                            <a href="{{ route('frontend.cart', ['locale' => get_lang()]) }}"
                                                class="position-relative" id="boxOfProduct">
...
<div class="d-xl-none">
    <nav class="navbar navbar-expand-xl navbar-light">
        <div class="collapse navbar-collapse" id="navbarNav">
            <form class="mt-2 mt-md-0 col-12 border-bottom">
            ...
            <div class="navbar-top-mobile">
                <div class="container">
                    <span class="m-3">โทร : 02-118-6096 <span class="Nshow-p">|</span> <br class="show-p"> 日本語 :
                        063-203-9807 (9:30-18:30)</span>
                    <div class="box-social pb-3">
                        @php
                        $lang = array('/th/', '/en/');
                        @endphp
                        <a href="{{ str_replace($lang, '/th/', request()->url()) }}" class="I-EN">
                            <img src="{{ asset('images/I-TH.png') }}">
                        </a>
                        <a href="{{ str_replace($lang, '/en/', request()->url()) }}" class="I-TH">
                            <img src="{{ asset('images/I-EN.png') }}">
                        </a>
                        <a class="align-middle">|</a>
                        @foreach($main['web_socials'] as $web_social)
