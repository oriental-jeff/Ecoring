      ...
      <div class="col-lg-3">
        ...
        <div class="text-off-on">
          <div class="row box-bank">
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank1.jpg') }}" class="icon-bank">
            </div>
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank2.jpg') }}" class="icon-bank">
            </div>
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank3.jpg') }}" class="icon-bank">
            </div>
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank4.jpg') }}" class="icon-bank">
            </div>
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank5.jpg') }}" class="icon-bank">
            </div>
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank6.jpg') }}" class="icon-bank">
            </div>
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank7.jpg') }}" class="icon-bank">
            </div>
            <div class="col-3">
              <img src="{{ asset('images/icon-footer/icon-bank8.jpg') }}" class="icon-bank">
            </div>
          </div>
          ...
          <div class="row box-bank">
            <div class="col-6">
              <img src="{{ asset('images/icon-footer/ep-EMS.jpg') }}" class="icon-bank">
            </div>
            <div class="col-6">
              <img src="{{ asset('images/icon-footer/ep-Kerry.jpg') }}" class="icon-bank">
            </div>
            <div class="col-6">
              <img src="{{ asset('images/icon-footer/ep-Flash.jpg') }}" class="icon-bank">
            </div>
          </div>
        </div>
      </div>
