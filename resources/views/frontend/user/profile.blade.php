                ...
                <div class="col-lg-3">
                    <div class="b-sticky text-center">
                        <div class="img rounded-circle border border-light mx-auto mb-3" id="preview-avatar"
                            ...
                            <img
                                src="{{ empty($user->profiles->avatar) ? asset('images/img-profile.jpg') : $user->profiles->avatar }}">
                        </div>
                        <h4>{{ $user->name }}</h4>
                        <p>
                        ...
                        <div class="row">
                            <div class="col-6 pr-0">
                                <form
                                    ...
                                    @method('patch')
                                    @csrf
                                    <button type="button" class="btn font-weight-light radius-25 w-100"
                            ...
                            <div class="box-body text-left" style="max-width:none;">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email2" value="{{ $user->email }}"
                                            disabled>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-3">
                                        ...
                                        <select class="form-control area-select" id="province" name="province"
                                            data-size="10" data-live-search="true" required="" readonly>
                                ...
                                <div id="box-deli-address">
                                    ...
                                    <div class="form-row content-deli-address" id="content-deli-address-{{ $key + 1 }}">
                                        <div class="col-12">
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control deli-fullname" id="delivery_fullname_{{ $key + 1 }}"
                                                name="delivery_fullname[]" value="{{ $deli_address->fullname }}"
                                                required readonly>
                                        </div>

                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <label for="delivery_telephone">{{ __('messages.telephone') }}</label>
                                            <input type="tel" class="form-control deli-telephone" id="delivery_telephone_{{ $key + 1 }}"
                                                name="delivery_telephone[]" value="{{ $deli_address->telephone }}"
                                                required="" readonly>
                                        </div>

                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <label for="delivery_address">{{ __('messages.address') }}</label>
                                            <input type="text" class="form-control deli-address" id="delivery_address_{{ $key + 1 }}"
                                                name="delivery_address[]" value="{{ $deli_address->address }}"
                                                required="" readonly>
                                        </div>

                                        <div class="col-lg-3 col-md-6 mb-3">
                                            <label for="delivery_province">{{ __('messages.province') }}</label>
                                            <select class="form-control area-select deli-province"
                                                id="delivery_province_{{ $key + 1 }}" name="delivery_province[]" data-size="10"
                                                data-live-search="true" onchange="changeLogisticProvince(this)" required readonly>
                                                <option value="">{{ __('messages.please_select') }}</option>
                                        ...
                                        <div class="col-lg-4 col-md-6 mb-3">
                                            ...
                                            <input type="tel" class="form-control deli-postcode" id="delivery_postcode_{{ $key + 1 }}"
                                                name="delivery_postcode[]" value="{{ $deli_address->postcode }}"
                                                required="" readonly>
                                        </div>

                                        <input type="hidden" id="deli-address-id-{{ $key + 1 }}" name="deli_address_id[]"
                                            value="{{ $deli_address->id }}">
                                    </div>
                                    <hr>
                                    @endforeach
                                </div>
...
<script>
    function increaseDeliveryAddress() {
        ...
        clone.find('.deli-fullname').attr({id: 'delivery_fullname_' + count, name: 'new_delivery_fullname[]'});
        clone.find('.deli-telephone').attr({id: 'delivery_telephone_' + count, name: 'new_delivery_telephone[]'});
        clone.find('.deli-address').attr({id: 'delivery_address_' + count, name: 'new_delivery_address[]'});
        clone.find('.deli-postcode').attr({id: 'delivery_postcode_' + count, name: 'new_delivery_postcode[]'});
...
//   Delivery Address
  function changeLogisticProvince(obj) {
    ...
    $('#delivery_district_' + count).attr('readonly', false).html(opt);
