            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="b-sticky text-center">
                        <div class="img rounded-circle border border-light mx-auto mb-3" id="preview-avatar" style="max-width: 200px;">
                        ...
                        <div class="row">
                            <div class="col-6 pr-0">
                                <form action="{{ route('frontend.user.update', ['locale' => get_lang(), 'user' => $user->id]) }}" method="POST" enctype="multipart/form-data" id="form-avatar">
                                    @method('patch')
                                    @csrf
