...
var handleBarChart = function() {
  console.log(bar)
    ...
    nv.addGraph(function() {
        ...
        barChart.yAxis.axisLabel("Time(Min)");
        barChart.xAxis.axisLabel('Project');
...
var handlePieAndDonutChart = function() {
    "use strict";
    //console.log(donut)
    var pieChartData = $.parseJSON(donut);
    /*[
...
var handlePieLate = function() {
    "use strict";
    console.log(late)
      var pieChartData = $.parseJSON(late);
    /*[
        { 'label': 'One', 'value' : 29, 'color': COLOR_RED }, 
        { 'label': 'Two', 'value' : 12, 'color': COLOR_ORANGE }, 
        { 'label': 'Three', 'value' : 32, 'color': COLOR_GREEN }, 
      ...
      nv.addGraph(function() {
        var pieChart = nv.models.pieChart()
          ...
          .showLabels(true)
          .labelThreshold(.05);
        d3.select('#nv-donut-late').append('svg')
            .datum(pieChartData)
            .transition().duration(350)
            .call(pieChart);
        return pieChart;
...
var handlePieLeave = function() {
    "use strict";
    var pieChartData = $.parseJSON(leave);
    /*[
        { 'label': 'One', 'value' : 29, 'color': COLOR_RED }, 
        { 'label': 'Two', 'value' : 12, 'color': COLOR_ORANGE }, 
        { 'label': 'Three', 'value' : 32, 'color': COLOR_GREEN }, 
    ...
    nv.addGraph(function() {
        var pieChart = nv.models.pieChart()
          ...
          //.labelType("percent")
          .labelThreshold(.05);
        d3.select('#nv-donut-leave').append('svg')
            .datum(pieChartData)
            .transition().duration(350)
            .call(pieChart);
        return pieChart;
